...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	  module.exports = function(nodeScope) {
	    ...
	    dataWaiter = new __webpack_require__(4)('../global/dataWaiter.js')();
	    handler = function(e) {
	      var curIndex, curLi, i, index, item, j, k, len, len1, li, target, thisLi, type, url;
	      target = e.target;
	      type = e.type;
	      curLi = ul.Q('.active');
	      ...
	      if (thisLi) {
	        ...
	        if (type === 'click' || type === 'touchend') {
	          ...
	          return queryData(url, {}, function(res) {
	            dataWaiter.close();
	            return console.log(res['data']['content']);
	          });
	        } else {
