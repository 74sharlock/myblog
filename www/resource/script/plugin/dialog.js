...
// artDialog - 默认配置
    define("dialog-config", {
        ...
        // 注意：css 只允许加载一个
        cssUri: '',//'/resource/stylesheet/plugin/ui-dialog.css'
...
// css loader: RequireJS & SeaJS
        ...
        var artDialog = function (options, ok, cancel) {
            ...
            if (options.ok) {
                ...
                if(options['okIcon']){
                    okConfig['icon'] = options['okIcon'];
                }
                options.button.push(okConfig);
            }
            ...
            if (options.cancel) {
                ...
                if(options['cancelIcon']){
                    cancelConfig['icon'] = options['cancelIcon'];
                }
                options.button.push(cancelConfig);
            }
                    ...
                    $.each(args, function (i, val) {
                        ...
                        html +=
                            '<button'
                                ...
                                + (val.className ? 'class="' + val.className + '"' : '') /*modify by sharlock (2015-04-16)*/
                                + '>'
                                + (val.icon ? val.icon: '') /*modify by sharlock (2015-04-16)*/
                                +   val.value
                                + '</button>';
